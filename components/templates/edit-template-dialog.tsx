...
import { FileText, MessageSquare, Image, Video, File, Save, Trash2 } from "lucide-react"
  ...
  useEffect(() => {
    if (template) {
      ...
      form.reset({
        ...
        templateType: contentJSON.type || "text",
        content: contentJSON.text || contentJSON.content || "",
        variables: variables,
        approvedTag: template.approvedTag || "DRAFT"
      })
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Modifica los detalles de la plantilla seleccionada.
          </DialogDescription>
        </DialogHeader>
